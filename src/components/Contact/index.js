...
function ContactPage() {
    return (
        <section>
            <h1 className="contactMeHead has-text-centered is-size-1 has-text-weight-bold">Contact Me</h1>
            <div className="has-text-centered">
            <img className="contactPic" src={require('../../../src/assets/email-13781.png')} alt="profilePhoto"
                    width='45%'
                    height='45%' />
            </div>
